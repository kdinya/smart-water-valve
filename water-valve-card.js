// ═══════════════════════════════════════════════════════════════
//  Water Valve Card  v3.3.0 — труби з водою на всю ширину,
...
try {
  ...
  console.warn(
    "water-valve-card already defined — hard refresh the browser (Ctrl+F5) to load v3.3.0",
    err
  );
}

console.info(
  "%c WATER-VALVE-CARD %c v3.3.0 ",
